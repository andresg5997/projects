...
followRouter.get('/following', cors.cors, authenticate.verifyUser, (req, res, next) => {
...
followRouter.get('/followers/:playerId', cors.cors, (req, res, next) => {
...
followRouter.get('/following/:playerId', cors.cors, (req, res, next) => {
	User.users.findById(req.params.playerId)
	.then((player) => {
		if(player != null){
