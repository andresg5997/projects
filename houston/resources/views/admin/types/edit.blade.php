                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-Teal">
                        <div class="box-header with-border">
                            <h3 class="box-title"><i class="fa fa-edit"></i> Edit Event Type | <span
                                        style="color:#3c8dbc">{{$type->name}}</span></h3>
                        </div><!-- /.box-header -->
                        <!-- form start -->
                        {!! Form::model($type, ['method' => 'PATCH', 'route' => ['admin.types.update', $type->id]]) !!}
