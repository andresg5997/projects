                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-Teal">
                        <div class="box-header with-border">
                            <h3 class="box-title"><i class="fa fa-edit"></i> Edit Archive | <span
                                        style="color:#3c8dbc">{{$archive->name}}</span></h3>
                        </div><!-- /.box-header -->
                        <!-- form start -->
                        {!! Form::model($archive, ['method' => 'PATCH', 'route' => ['admin.archives.update', $archive->id]]) !!}
                        @if (session()->has('flash_notification.message'))
                            <div class="alert alert-{{ session('flash_notification.level') }}">
                                <button archive="button" class="close" data-dismiss="alert" aria-hidden="true">&times;
                                </button>
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <button archive="submit" class="btn bg-default btn-app"><i class="fa fa-save"></i>
                                        Update
                                    </button>
                                </div>
                            </div>
