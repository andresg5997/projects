...
<head>
    ...
    <title>Honest Sports' Email</title>
                            ...
                            <table style="margin:0 auto;" cellspacing="0" cellpadding="0" width="100%">
                                <tr>
                                    <td style="text-align: center;">
                                        <a href="#"><img class="w320" width="311" src="{{ url('/') }}/assets/images/logo.png" alt="company logo" ></a>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table cellspacing="0" cellpadding="0" bgcolor="#363636"  class="force-full-width">
                                <tr>
                                    <td style="background-color:#363636; text-align:center;">
                                        <br>
                                        <br>
                                        <a href="{{ config('facebook') }}"><img width="68" height="56" src="https://www.filepicker.io/api/file/W6gXqm5BRL6qSvQRcI7u"></a>
                                        <a href="{{ config('twitter') }}"><img width="61" height="56" src="https://www.filepicker.io/api/file/eV9YfQkBTiaOu9PA9gxv"></a>
                                        <br>
                                        <br>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td style="color:#27aa90; font-size: 14px; text-align:center;">
                                        <a href="#">View in browser</a> | <a href="{{ url('contact') }}">Contact</a> | <a href="{{ url('/') }}/settings/notifications">Unsubscribe</a>
                                    </td>
                                </tr>
                                <tr>
