@extends('layouts.app', ['title' => trans('player.register')])
...
<main class="container">
		<h1>{{ trans('player.register') }}</h1>
		{!! Form::open(['action' => ['Team\PlayerController@store', $team->id], 'method' => 'POST']) !!}
			<div class="row">
				...
				<div class="col-md-5">
				 ...
				 <div class="col-md-5">
					...
					<div class="form-group">
						...
						{!! Form::number('phone', null, ['class' => 'form-control', 'placeholder' => trans('player.phone')]) !!}
					</div>
				 </div>
				 <div class="col-md-2">
