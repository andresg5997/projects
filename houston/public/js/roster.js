...
__WEBPACK_IMPORTED_MODULE_1_vue___default.a.directive('mask', __WEBPACK_IMPORTED_MODULE_2_v_mask__["a" /* VueMaskDirective */]);
...
var app = new __WEBPACK_IMPORTED_MODULE_1_vue___default.a({
    ...
    methods: {
        emptyForm: function emptyForm() {
            ...
            playerForm.reset();
            var csrf_token = this.form.csrf_token;
            var team_id = this.form.team_id;
        ...
        sendPicture: function sendPicture() {
            ...
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.put('/updatePicture', this.updatePicture).then(function (res) {
                if (res.data.saved) {
        ...
        newPicture: function newPicture(event) {
            var _this2 = this;
            ...
            fileReader.onload = function (event) {
                _this2.updatePicture.picture = event.target.result;
            };
        },
        imageChanged: function imageChanged(event) {
            ...
            fileReader.onload = function (event) {
                _this3.form.picture = event.target.result;
            };
        },
        showImage: function showImage(input) {
            var output = document.getElementById('output');
            output.src = '';
        ...
        playerEdit: function playerEdit(player) {
        ...
        updatePlayer: function updatePlayer(id) {
            var _this4 = this;

            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.put('/teams/' + this.form.team_id + '/roster/' + id, this.form).then(function (res) {
                if (res.data.updated) {
                    swal('Success!', 'The player was successfully updated.', 'success');
                    _this4.errors = {};
                    _this4.editPlayer = false;
                    _this4.getData();
                    _this4.closeModal();
                }
            }).catch(function (error) {
                return setTimeout(function () {
                    return _this4.errors = error.response.data;
                }, 500);
            });
        },
        ...
        storePlayer: function storePlayer() {
            var _this5 = this;

            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('', this.form).then(function (res) {
        ...
        getData: function getData() {
            ...
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('ajax').then(function (res) {
                // console.log(res.data)
                _this6.players = res.data;
            });
        },
        deletePlayer: function deletePlayer(id) {
            swal({
                ...
                __WEBPACK_IMPORTED_MODULE_0_axios___default.a.delete('roster/' + id).then(function () {
                    swal('Deleted!', 'The player was deleted successfully', 'success');
                    var player = app.players.filter(function (player) {
