...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_autolink_js__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_autolink_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_autolink_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_v_mask__ = __webpack_require__(29);
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_4_v_mask__["b" /* default */]);
// import VueGoogleAutocomplete from 'vue-google-autocomplete'

window.dashboard = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    el: '#dashboard',
    data: function data() {
        return {
            invite: {
    ...
    methods: {
        getMediaPosts: function getMediaPosts() {
            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('/teams/' + storage.team_id + '/getMedia').then(function (res) {
                dashboard.mediaPosts = res.data.posts;
            }).catch(function (error) {
                console.log(error);
            });
        },
        deleteArchive: function deleteArchive(id) {
            swal({
                title: 'Are you sure?',
                type: 'warning',
                showCancelButton: true
            }).then(function () {
                __WEBPACK_IMPORTED_MODULE_1_axios___default.a.delete('/archives/' + id).then(function (res) {
                    if (res.data.deleted) {
        ...
        openEditCoach: function openEditCoach(id) {
            this.editCoach = this.team.coaches.filter(function (coach) {
                return coach.id == id;
            })[0];
        },
        updateCoach: function updateCoach() {
            ...
            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.put('/teams/' + storage.team_id + '/coach/' + this.editCoach.id, this.editCoach).then(function (res) {
                if (res.data.updated) {
                    _this.closeModal();
        ...
        questionRemoveCoach: function questionRemoveCoach(id) {
            swal({
                title: 'Are you sure?',
                type: 'warning',
                showCancelButton: true
            }).then(function () {
                __WEBPACK_IMPORTED_MODULE_1_axios___default.a.delete('/teams/' + storage.team_id + '/coach/' + id).then(function (res) {
                    if (res.data.deleted) {
        ...
        submitCoach: function submitCoach() {
            var _this2 = this;

            this.errors = {};
            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post('/teams/' + storage.team_id + '/coach', this.coach).then(function (res) {
                if (res.data.saved) {
                    _this2.closeModal();
        ...
        updateViewPost: function updateViewPost(post) {
            this.viewPost = post;
            this.postModalTitle = this.viewTitle;
        },
        deleteMedia: function deleteMedia(slug, index) {
            var _this3 = this;

            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.delete(this.deleteMediaLink + '/' + slug).then(function (res) {
                swal('Media has been deleted!', '', 'success');
                dashboard.updatePosts();
                _this3.postFields.medias.splice(index, 1);
            }).catch(function (error) {
        ...
        updatePost: function updatePost() {
            ...
            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.put('/updatePost', this.postFields).then(function () {
                dashboard.updatePosts();
                swal('Your post was updated!', '', 'success');
                edit: false;
                _this4.postFields.content = '';
                _this4.postFields.subject = '';
                _this4.postFields.id = '';
                _this4.postFields.files = 0;
                _this4.postFields.medias = null;
            }).catch(function (error) {
                console.error(error);
                swal('Error!', '', 'error');
            });
        ...
        submitMessage: function submitMessage() {
            if (this.postFields.content != '' || this.postFields.subject != '') {
                if (this.postFields.files > 0) {
                    ...
                    __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post("/post/store", this.postFields).then(function (res) {
                        swal({
                            title: 'Posted!',
        ...
        updatePosts: function updatePosts() {
            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('/postsTeam/' + storage.team_id).then(function (response) {
                // dashboard.posts = response.data;
                dashboard.posts = response.data.map(function (post) {
                    post.parsedContent = __WEBPACK_IMPORTED_MODULE_3_autolink_js___default()(post.content);
                    return post;
                });
            }).catch(function (error) {
                console.log(error);
        ...
        fullName: function fullName(elem) {
        ...
        comment: function comment(id) {
            ...
            swal({
                ...
                __WEBPACK_IMPORTED_MODULE_1_axios___default.a.put("/putComment", dashboard.commentFields).then(function (res) {
                    dashboard.updatePosts();
                    swal({
        ...
        editComment: function editComment(id, comment) {
            ...
            swal({
                ...
                dashboard.commentFields.body = text;
                __WEBPACK_IMPORTED_MODULE_1_axios___default.a.put("/updateComment", dashboard.commentFields).then(function (res) {
                    dashboard.updatePosts();
        ...
        getEvents: function getEvents() {
            ...
            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('/teams/' + this.postFields.team_id + '/dashboardEvents').then(function (res) {
                _this5.events = res.data.events;
                _this5.events.map(function (event) {
                    if (event.goals_1) {
                        event.status = 'loaded';
                    } else {
                        event.status = _this5.eStatus(event.date);
                    }
                });
                _this5.season = res.data.season;
                setTimeout(function () {
                    $('.editable').editable({});
                }, 1000);
            }).catch(function (error) {
        ...
        sendInvitationForm: function sendInvitationForm() {
            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post('/teams/' + parseInt(storage.team_id) + '/invite', { email: this.invite.email, name: this.invite.name }).then(function (res) {
