...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_v_mask__ = __webpack_require__(29);




__WEBPACK_IMPORTED_MODULE_0_vue___default.a.directive('mask', __WEBPACK_IMPORTED_MODULE_2_v_mask__["a" /* VueMaskDirective */]);
...
var app = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    ...
    methods: {
        ...
        onUpdate: function onUpdate() {
            ...
            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.put('/teams/' + this.editForm.id, this.editForm).then(function (res) {
                if (res.data.saved) {
                ...
                console.log(error.response.data);
                _this2.editErrors = error.response.data;
            });
        },
        getLocation: function getLocation() {
            ...
            navigator.geolocation.getCurrentPosition(function (position) {
                ...
                __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('http://maps.googleapis.com/maps/api/geocode/json?latlng=' + lat + ',' + lng + '&sensor=true').then(function (res) {
                    var address = res.data.results[0];
                    _this3.form.city = address.address_components[1].long_name;
                    _this3.form.country = address.address_components[4].short_name;

                    __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('https://maps.googleapis.com/maps/api/timezone/json?location=' + lat + ',' + lng + '&timestamp=1458000000&key=AIzaSyBu-oadicxmzndvONC3xDJcIwWbd7NZTQ4').then(function (res) {
                        _this3.form.timezone = res.data.timeZoneId;
        ...
        edit: function edit(id) {
            ...
            // console.log(id)
            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('getTeam/' + id).then(function (res) {
                _this4.editForm = res.data.team;
                _this4.editForm.csrf_token = _this4.form.csrf_token;
                _this4.editForm.image = '';
            });
        },
        imageChanged: function imageChanged(event) {
            ...
            fileReader.onload = function (event) {
                _this5.form.avatar = event.target.result;
            };
        },
        editImageChanged: function editImageChanged(event) {
            var _this6 = this;
            ...
            fileReader.onload = function (event) {
                _this6.editForm.image = event.target.result;
            };
        },
        showImage: function showImage(input, output) {
        ...
        deleteTeam: function deleteTeam(id) {
            swal({
                ...
                __WEBPACK_IMPORTED_MODULE_1_axios___default.a.delete('/teams/' + id).then(function (res) {
                    if (res.data.deleted) {
                        swal('Deleted!', 'The team was deleted successfully', 'success');
                        setTimeout(location.reload.bind(location), 2500);
                    }
                });
            });
