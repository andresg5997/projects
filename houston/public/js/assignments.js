...
new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    ...
    methods: {
        ...
        hasAssignment: function hasAssignment(player, event) {
            var assignment = event.assignments.filter(function (assignment) {
        ...
        getData: function getData() {
            ...
            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('/teams/' + this.form.team_id + '/getAssignments').then(function (res) {
                _this.assignments = res.data.assignments;
