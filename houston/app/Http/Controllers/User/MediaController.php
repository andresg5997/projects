...
class MediaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('media.store', compact('categories'));
    }
    ...
    public function directUploadHandler(UploadMediaRequest $request)
    {
        $domain = url('/').'/';
        ...
        foreach ($files as $file) {
            ...
            if ($receiver->isUploaded()) {
                ...
                if ($save->isFinished()) {
                    ...
                    return $this->createMedia($new_file_name, $request, $upload_session, $private, $domain, $handler_output[0], $response, $original_name, $extension, $file_size);
                } else {
