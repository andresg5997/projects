...
class CreateAffiliateAudioViewsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('affiliate_audio_views', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('affiliate_audio_views');
    }
}
