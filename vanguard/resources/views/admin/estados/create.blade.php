		...
		<div class="card-content">
			...
			<form @submit.prevent="store">
				...
				<div class="row">
					<div class="col s6">
						<label>Proceso</label>
						{{-- Si viene de procesos --}}
						<input v-if="lockProceso === 1" disabled v-model="form.proceso.nombre">
						{{-- Si viene de estados --}}
						<multiselect @select="getEstados()" v-if="lockProceso == 0" v-model="form.proceso"
					...
					<div class="col s6">
						<template v-if="showEstados === 1">
							...
							:options="estados" label="nombre" :multiple="true" placeholder="Escoger opciones"
							select-label="Presiona enter para elegir"
							selected="Elegido"
							deselect-label="Presiona enter para quitar"
							>
					...
					<div class="col s12">
						...
						<div class="row" v-for="(requisito, index) in form.requisitos">
							...
							<div class="col s4 input-field">
								...
								<input type="text" v-model="form.requisitos[index].nombre" :placeholder="'Actividad ' + (index+1)">
							</div>
							<div class="col s3">
