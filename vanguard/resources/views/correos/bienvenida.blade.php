...
@foreach($data as $key => $valor)
  <p>{{ $key }}: {{ $valor }}</p>
{{-- <p>Nombre del cliente: {{ $data['cliente_nombre'] }}</p>
<p>titulo de tarea: {{ $data['estado_titulo_tarea'] }}</p>
<p>estado 24-hace algo mas: {{ $data['24_hace_algo_mas'] }}</p>
<p>estado 21-seleccion: {{ $data['32_seleccion'] }}</p> --}}
@endforeach
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <table width="583" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="left" valign="top" bgcolor="#FFFFFF" style="background-color:#FFFFFF;">Aqui iba otra imagen</td>
      </tr>
      <tr>
        <td align="left" valign="top" bgcolor="#FFFFFF" style="background-color:#FFFFFF;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="left" valign="top">Aqui otra</td>
              </tr>
              <tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="13%"><b>Aqui iban las imagenes</b></td>
