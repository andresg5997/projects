...
<meta property="og:title" content="NETWORK LATINO email de calificación" />
</head>
<!--[if mso]>
  <body class="mso">
<![endif]-->
...
<!--<![endif]-->
    <table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #fff;" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
      <div role="banner">
        ...
        <img src="http://35.202.15.111:8080/img/network-latino.jpg" width="100" height="100" align="Center">
      ...
      <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
        <p style="Margin-top: 0;Margin-bottom: 0;">Estimado,</p><p style="Margin-top: 20px;Margin-bottom: 0;">Anexo informaci&#243;n para CALIFICAR &nbsp;cliente para el servicio de DIRECT TV</p><p style="Margin-top: 20px;Margin-bottom: 0;">Nombre:</p>{{ $data['cliente_nombre'] }}<p style="Margin-top: 20px;Margin-bottom: 0;">Tel&#233;fono:</p>{{ $data['cliente_telefono'] }}<p style="Margin-top: 20px;Margin-bottom: 0;">Direcci&#243;n:</p>{{ $data['cliente_direccion'] }}<p style="Margin-top: 20px;Margin-bottom: 0;">&nbsp;</p>
      </div>
    </div>
        <table width="200" height="44" cellpadding="0" cellspacing="0" border="0" bgcolor="#64FE2E" style="border-radius:4px;">
  <tr>
    <td align="center" valign="middle" height="44" style="font-family: Arial, sans-serif; font-size:14px; font-weight:bold;">
      <a href="https://api.whatsapp.com/send?phone=584146309520&text=Por Favor Calificar, {{$data['cliente_nombre']}}, {{$data['cliente_direccion']}}, {{ $data['cliente_telefono'] }}" target="_blank" style="font-family: Arial, sans-serif; color:#ffffff; display: inline-block; text-decoration: none; line-height:44px; width:200px; font-weight:bold;">Enviar por Whatsapp</a>
    </td>
  </tr>
</table>
          </div>
            ...
            <div class="column wide" style="text-align: left;font-size: 12px;line-height: 19px;color: #adb3b9;font-family: sans-serif;Float: left;max-width: 400px;min-width: 320px; width: 320px;width: calc(8000% - 47600px);">
              <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;">
                ...
                <div style="font-size: 12px;line-height: 19px;">
                  <div>Network Latino LLC</div>
                </div>
                <div style="font-size: 12px;line-height: 19px;Margin-top: 18px;">
                  <div>Phone: &nbsp;(832)-275-4171</div>
                </div>
                <!--[if mso]>&nbsp;<![endif]-->
              </div>
            </div>
