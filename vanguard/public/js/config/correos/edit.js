...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.directive("material-select", {
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.directive("material-select-1", {
  bind: function bind(el, binding, vnode) {
    $(function () {
      $(el).material_select();
    });
