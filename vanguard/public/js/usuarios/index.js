...
var app = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
	...
	methods: {
		getData: function getData() {
			...
			__WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(laroute.route('api.usuarios')).then(function (res) {
		...
		remove: function remove(usuario) {
			__WEBPACK_IMPORTED_MODULE_2_sweetalert2___default()({
				...
				__WEBPACK_IMPORTED_MODULE_1_axios___default.a.delete(laroute.route('api.usuario', { id: usuario.id })).then(function (res) {
					if (res.data.deleted) {
						__WEBPACK_IMPORTED_MODULE_2_sweetalert2___default()('Hecho', 'Usuario eliminado correctamente.', 'success');
						app.usuarios.splice(app.usuarios.indexOf(usuario), 1);
						return;
					}
				}).catch(function (error) {
					__WEBPACK_IMPORTED_MODULE_2_sweetalert2___default()('Algo ocurrió!', '', 'error');
				});
			});
		},
		changeType: function changeType(usuario) {
			...
			__WEBPACK_IMPORTED_MODULE_2_sweetalert2___default()({
				...
				__WEBPACK_IMPORTED_MODULE_1_axios___default.a.post(laroute.route('api.changeType'), usuario).then(function (res) {
					if (res.data.update) {
						__WEBPACK_IMPORTED_MODULE_2_sweetalert2___default()({
							type: 'success',
		...
		nombreCompleto: function nombreCompleto(usuario) {
