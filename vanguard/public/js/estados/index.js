...
new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    ...
    methods: {
        getData: function getData() {
            ...
            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(laroute.route('api.estados')).then(function (res) {
                _this.estados = res.data.estados;
            });
        ...
        deleteEstado: function deleteEstado(id, index) {
            var _this2 = this;
            ...
            __WEBPACK_IMPORTED_MODULE_4_sweetalert2___default()({
                ...
                __WEBPACK_IMPORTED_MODULE_1_axios___default.a.delete(laroute.route('estados.destroy', { estado: id })).then(function (res) {
                    if (res.data.deleted) {
                        __WEBPACK_IMPORTED_MODULE_4_sweetalert2___default()('Hecho!', 'El estado ha sido eliminado.', 'success');
                        _this2.estados.splice(index, 1);
                    }
                });
            });
        },
    ...
    computed: {
        noPosteriores: function noPosteriores() {
            return this.estados.filter(function (estado) {
                return estado.posteriores === undefined;
            });
        }
    }
});
