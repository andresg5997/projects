...
new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
  ...
  methods: {
    ...
    submit: function submit() {
      ...
      __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post(laroute.route('api.procesos.store'), this.form).then(function (res) {
        if (res.data.saved) {
          _this2.procesos.push(res.data.proceso);
          $('#procesoModal').modal('close');
          __WEBPACK_IMPORTED_MODULE_2_toastr___default.a.success('El proceso se ha guardado con éxito!');
        }
      }).catch(function (err) {
