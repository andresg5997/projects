...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_sweetalert2__ = __webpack_require__(156);
...
new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    ...
    methods: {
        getData: function getData() {
            ...
            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(laroute.route('api.proceso', { id: this.proceso_id })).then(function (res) {
                _this.proceso = res.data.proceso;
            });
            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(laroute.route('api.estados')).then(function (res) {
                res.data.estados.forEach(function (estado) {
                    if (estado.proceso_id == _this.proceso_id) {
                        _this.procesoEstados.push(estado);
                    }
                });
            });
        },
        deleteEstado: function deleteEstado(id, index) {
            ...
            __WEBPACK_IMPORTED_MODULE_2_sweetalert2___default()({
                ...
                __WEBPACK_IMPORTED_MODULE_1_axios___default.a.delete(laroute.route('estados.destroy', { estado: id })).then(function (res) {
                    if (res.data.deleted) {
                        __WEBPACK_IMPORTED_MODULE_2_sweetalert2___default()('Hecho!', 'El estado ha sido eliminado.', 'success');
                        _this2.procesoEstados.splice(index, 1);
                    }
                });
            });
        },
